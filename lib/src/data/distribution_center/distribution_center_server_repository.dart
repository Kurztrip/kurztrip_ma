...
class DistributionCenterServerRepository implements DistributionCenterRepository {
...
*/
  ...
  Future<DistributionCenter> get(int id) async {
    final QueryOptions options = QueryOptions(
      document: gql(getDistributionCenterMA), //NOMBRE DEL STRING QUERY O MUTATION
    ...
    final distribution_center_result = result.data['getDistributionCenter']; //FUNCION DE GRAPHQL
    ...
    return DistributionCenter(
        ...
        available_space: distribution_center_result['available_space'].toDouble());
  }
...
*/
  ...
  Future<List<DistributionCenter>> getAll() async {
    final QueryOptions options = QueryOptions(document: gql(getDistributionCentersMA) //NOMBRE DEL STRING QUERY O MUTATION
    ...
    List<DistributionCenter> centers = result.data['getDistributionCenters']
        .map<DistributionCenter>((DistributionCentersResult) => DistributionCenter(
              id: int.parse(DistributionCentersResult['id'].toString()),
              address: DistributionCentersResult['address'].toString(),
              latitude_location: double.parse(DistributionCentersResult['latitude_location'].toString()),
              longitude_location: double.parse(DistributionCentersResult['longitude'].toString()),
              total_space: double.parse(DistributionCentersResult['total_space'].toString()),
              available_space: double.parse(DistributionCentersResult['available_space'].toString()),
            ))
        .toList();
